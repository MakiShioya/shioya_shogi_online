// script/main_online_player.js (Clean Version)
        ...
        if (legalMoves.some(m => m.x === x && m.y === y)) {
            ...
            if (currentSkill && currentSkill.isSystemAction) {
                ...
                if (socket) {
                    ...
                    // 盤面同期送信
                    const newState = deepCopyState(); // 関数で取得
                    // サーバーへ送るデータには不要なものは含めない
                    const sendState = {
