...
const charData = {
  ...
  "default": {
    ...
    skillName: "シルバーアーマー",
    skillDesc: "自身の「銀」「成銀」「成桂」「成香」のうち一つを選び、自分の玉の周囲８マスから１マスを選択し、移動させる。手番が終わる。<br>発動条件：なし<br>コスト：100<br>増加コスト300"
  },
  ...
  "char_a": {
    ...
    skillName: "熱烈な応援",
    skillDesc: "自分の「銀」「桂」「香」を１枚選択し、その場で成る。<br>この手番中は、「この手番にこの必殺技で成った駒」で、相手の駒を取ることはできない。<br>発動条件：なし<br>コスト：50<br>増加コスト300"
  },
  ...
  "char_b": {
    ...
    skillName: "ブループリント",
    skillDesc: "振り飛車限定の必殺技。自分の飛車か角を１枚選択し、その場で成る。<br>この手番中は、「この手番にこの必殺技で成った駒」で、相手の駒を取ることはできない。<br>発動条件：10手目以内に振り飛車にしていること。<br>コスト：200<br>増加コスト500"
  },
  ...
  "char_d": {
    ...
    skillName: "タイムワープ",
    skillDesc: "ひとつ前の自分の番まで時を戻す。相手の必殺技を巻き込んで戻ることはできない。<br>発動条件：現在の手番が始まって10秒以内（近日追加予定）。<br>直前の手番に相手が必殺技を使っていないこと。<br>コスト：300<br>増加コスト200"
  }
